...
- Fixed identifier placeholder handling by routing SQL with `??` through `connection.query`.
- Verified on 2026-01-15 with `bun run sync -- --dry-run` (no errors, dry run completed).
